package com.selectica.Package201506161.eclm.definitions.CGenBO.CGenDetails.scripts;

import com.selectica.Package201506161.stubs.CGenAddresses;
...
public class ShowSuccessMessageScript  extends AbstractDataReadScript<Boolean> {
    ...
    public Boolean process() throws Exception {
        ...
        if(!"WFAmendmentActivation".equals(event) && !serviceAPI.isImport(userWrapper)){
            ...
            String path = serviceAPI.getAddComponentLink(CGenAddresses.NAME, bundleWrapper);
